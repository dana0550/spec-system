...
The standalone instruction-set interface is deprecated.

Use the Spec System v2 interfaces instead:
...
- CLI: `specctl` (`init`, `feature create`, `lint`, `render`, `check`, `approve`, `migrate-v1-to-v2`, `report`)
