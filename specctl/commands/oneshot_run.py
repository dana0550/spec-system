...
def run(args) -> int:
    ...
    for checkpoint in checkpoints:
        ...
        append_event(run_dir, {"type": "checkpoint_start", "checkpoint_id": checkpoint_id, "runner": runner})
        prompt_path = run_dir / f"{checkpoint_id}.prompt.md"
        ...
        if isinstance(runner_command, str) and runner_command.strip():
            ...
            append_event(
                run_dir,
                {
                    ...
                    "prompt_path": str(prompt_path),
                    "rc": 0,
                    "output": "Runner command not configured; validation-only execution.",
                },
            )
        ...
        while not success and retry_count < max_retries:
            ...
            append_event(
                run_dir,
                {"type": "repair_attempt", "checkpoint_id": checkpoint_id, "attempt": retry_count},
            )
